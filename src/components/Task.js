...
export default props => { //função arrow
    let check = null      // icone verde checado
    if (props.doneAt !== null) { // se data diferente de nulo
        check = (
    ...
    // TouchableWithoutFeedback refere-se ao botão da verde da tarefa
            ...
            <View style={styles.container}>
                ...
                <View>
                    ...
                    <Text style={styles.date}>
                        {moment(props.estimateAt).locale('en-gb').format('ddd, D [] MMMM [] YYYY')}</Text>
                </View>
            </View>
        </Swipeable>
    )
